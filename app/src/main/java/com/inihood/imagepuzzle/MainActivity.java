package com.inihood.imagepuzzle;
...
//            mp.start();
        ...
        ((Switch) findViewById(R.id.config_mute)).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        ((Switch) findViewById(R.id.config_mode)).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ed.putInt("mode", 1);
    ...
    void START() {
        ...
        for (int i = 0; i < num_rows * num_cols; i++) {
            ...
            item.setLayoutParams(new ViewGroup.LayoutParams(item_size, item_size));
